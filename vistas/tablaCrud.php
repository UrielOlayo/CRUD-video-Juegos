...
#puedo utilizar esta consulta pero nee $sql = "SELECT id_videojuego,nombre,tipo,fechaLanzamiento,descripcion FROM t_videojuegos";

$sql = "SELECT * FROM t_videojuegos";
